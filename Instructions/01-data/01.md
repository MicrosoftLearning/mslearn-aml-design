...
<img style="float:right; width:50%; margin-bottom: 10px;" src="./media/mock-up-app.png" alt="Screenshot of app. User can put in medical information and select the button to analyze the data. The app then tells the user whether a patient has diabetes.">
...
<div id="id01" style="display:none;">
  <p>Remember you can click the green button to get more information about the use case. You can choose how much extra information you need to answer each question.</p>
</div>
