...
<button class="answerbutton" onclick="window.location.href='wrong';">Semi-structured</button>

<button class="answerbutton" onclick="window.location.href='wrong';">Unstructured</button>
