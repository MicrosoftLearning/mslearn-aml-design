...
One of our data engineers extracted a small subset of the data for us. He sent us the data as a CSV file via e-mail.
</details>

<details>
<summary class = "button">Open hint 3</summary>
If we open the file, the first few rows of data like this:
<code>
