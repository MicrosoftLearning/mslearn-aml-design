...
<button class="button" onclick="window.location.href='02A';">Tell me more about the team I'll work with.</button>

<button class="button" onclick="window.location.href='02B';">Tell me more about Proseware.</button>

<button class="button" onclick="window.location.href='02B';">Tell me more about my experience.</button>
